...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_PistolTest p_PistolTest;
        ...
        public static SteamVR_Input_ActionSet_PistolTest PistolTest
        {
            get
            {
                return SteamVR_Actions.p_PistolTest.GetCopy<SteamVR_Input_ActionSet_PistolTest>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_PistolTest = ((SteamVR_Input_ActionSet_PistolTest)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_PistolTest>("/actions/PistolTest")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.PistolTest};
        }
    }
}
